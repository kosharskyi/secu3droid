...
data class IdlingParamPacket(
    ...
    override fun parse(data: IntArray): InputPacket {
        ...
        idlregMinAngle = data.get2BytesSigned().toFloat() / ANGLE_DIVIDER
        idlregMaxAngle = data.get2BytesSigned().toFloat() / ANGLE_DIVIDER
        idlregTurnOnTemp = data.get2BytesSigned().toFloat() / TEMPERATURE_MULTIPLIER
