...
data class AnglesParamPacket(
    ...
    override fun parse(data: IntArray): InputPacket {
        maxAngle = data.get2BytesSigned().toFloat() / ANGLE_DIVIDER
        minAngle = data.get2BytesSigned().toFloat() / ANGLE_DIVIDER
        angleCorrection = data.get2BytesSigned().toFloat() / ANGLE_DIVIDER
        ...
        shift_ingtim = data.get2BytesSigned().toFloat() / ANGLE_DIVIDER
