...
class SecuLogger @Inject constructor(private val prefs: UserPrefs, private val fileHelper: FileHelper) {
    ...
    private fun generateCsvTitle(delimeter: String): String {
        val values = listOf(
            ...
            "Knock retard(°CS)",
            "Air flow(1-16)",
            "Throttle lim.switch(0,1)",
            "Gas valve(0,1)",
            "Idle cutoff valve(0,1)",
            "Power valve(0,1)",
            "Cooling fan(0,1)",
            "Starter blocking(0,1)",
            "Acceleration enrichment(0,1)",
            "Rev.lim. fuel cut (0,1)",
            "Flood clear mode (0,1)",
            "System locked (0,1)",
            "CE lamp (0,1)",
            "IGN_I input (0,1)",
            "COND_I input (0,1)",
            "EPAS_I input (0,1)",
            "Afterstart enrichment (0,1)",
            "IAC closed loop (0,1)",
            "TPS(%)",
            "ADD_I1 Input(V)",
            "ADD_I2 Input(V)",
            ...
            "Fuel consumption(Hz)",
            "IAT sensor(°C)",
            "Adv.angle from start map(°CS)",
            "Adv.angle from idle map(°CS)",
            "Adv.angle from work map(°CS)",
            "Adv.angle corr.from CTS(°CS)",
            "Adv.angle corr.from IAT(°CS)",
            "Adv.angle corr.from idle reg.(°CS)",
            "Octane correction(°CS)",
            "EGO corr",
            "Injector PW(ms)",
            "TPS dot (%/s)",
            "MAP2, atmos. pressure (kPa)",
            "TMP2, gas temperature (°C)",
            "Diff.pressure, GPS-MAP (kPa)",
            "AFR value (6-24)",
            "Synthetic load (kPa or %)",
            "Barometric pressure (kPa)",
            "Begin inj. phase (°)",
            "End inj. phase (°)",
            "Gas reducer temperature (°C)",
            "Fuel tank level (L)",
            "Exhaust gas temperature (°C)",
            "Oil pressure (kg/cm2)",
            "Injector's duty (%)",
            "Argument in the IAC reg. rigidity map",
            "Air flow (RxL)",
            "MAF value (g/sec)",
            "Cooling fan's PWM duty (%)",
            "Bits of univ. outputs' states",
            "MAP dot (kPa/s)",
            "Fuel temperature (°C)",
            "Fuel consumed (L)",
            "EGO corr.2",
            "AFR value2 (6-24)",
            "AFR value from map (6-24)",
            "Charge temperature (°N)",
            "Gas pressure (kPa)",
            "Log Marks",
            "Service flags",
            "CE errors"
